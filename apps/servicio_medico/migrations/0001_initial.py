        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "estado",
                    models.CharField(
                        choices=[("O", "Operativa"), ("N", "No operativa")],
                        default="O",
                        max_length=1,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "modulo_origen",
                    models.CharField(
                        help_text="Módulo que envía la notificación", max_length=50
                    ),
                ),
                (
                    "solicitante",
                    models.CharField(
                        help_text="Nombre de quien solicita ayuda", max_length=100
                    ),
                ),
                (
                    "ubicacion",
                    models.CharField(help_text="Ubicación exacta", max_length=200),
                ),
                (
                    "tipo_urgencia",
                    models.CharField(help_text="Tipo de urgencia", max_length=100),
                ),
                (
                    "descripcion",
                    models.TextField(
                        help_text="Descripción detallada", max_length=1000
                    ),
                ),
                (
                    "estado",
                    models.CharField(
                        choices=[("P", "Pendiente"), ("A", "Atendida")],
                        default="P",
                        max_length=1,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "numero",
                    models.CharField(
                        help_text="Número del cuarto médico", max_length=10
                    ),
                ),
                (
                    "estado",
