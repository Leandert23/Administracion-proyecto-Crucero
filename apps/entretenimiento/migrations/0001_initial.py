    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "titulo",
                    models.CharField(
                        help_text="Título de la actividad", max_length=200
                    ),
                ),
                (
                    "descripcion",
                    models.TextField(help_text="Descripción completa de la actividad"),
                ),
                (
                    "dia_crucero",
                    models.IntegerField(
                ...
                (
                    "hora_inicio",
                    models.TimeField(help_text="Hora de inicio de la actividad"),
                ),
                (
                    "hora_fin",
                    models.TimeField(help_text="Hora de finalización de la actividad"),
                ),
                (
                    "maximoActividad",
                    models.IntegerField(help_text="Número máximo de participantes"),
                ),
                (
                    "img_src",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "titulo",
                    models.CharField(
                        help_text="Título de la actividad rutinaria", max_length=200
                    ),
                ),
                (
                    "descripcion",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "apellido",
                    models.CharField(help_text="Apellido del cliente", max_length=100),
                ),
                (
                    "n_habitacion",
                    models.CharField(
                        help_text="Número de habitación del cliente", max_length=20
                    ),
                ),
                (
                    "n_personas",
