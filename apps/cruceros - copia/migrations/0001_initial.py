    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        help_text="Toneladas de peso muerto",
                        max_digits=10,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, help_text="Número de cubiertas"
                    ),
                ),
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        default="",
                        help_text="Descripción general del crucero",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "duracion_dias",
                    models.IntegerField(
                        help_text="Duración total del ciclo de la ruta"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cubierta",
                    models.PositiveIntegerField(
                        default=1, help_text="Número de cubierta"
                    ),
                ),
                (
                    "codigo_ubicacion",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nombre_lugar",
                    models.CharField(
                        help_text="Nombre del puerto o 'Navegación'", max_length=100
                    ),
                ),
                ("pais", models.CharField(blank=True, max_length=100)),
                (
                    "dia_llegada",
                    models.IntegerField(help_text="Día en que se llega a esta etapa"),
                ),
                (
                    "tipo",
                    models.CharField(
                        choices=[("puerto", "Puerto"), ("navegacion", "Navegación")],
                        max_length=20,
                    ),
                ),
                ("descripcion", models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cubierta",
                    models.PositiveIntegerField(help_text="Número de cubierta"),
                ),
                (
                    "lado",
                    models.CharField(
                        choices=[("babor", "Babor"), ("estribor", "Estribor")],
                        help_text="Lado del barco",
                        max_length=10,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ruta",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="cruceros.ruta"
                    ),
                ),
            ],
            options={
