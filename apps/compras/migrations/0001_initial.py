    ...
    operations = [
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            ("VINO", "Vino"),
                            ("DESTILADO", "Destilado"),
                            ("COCTEL_PREMEZCLA", "Cóctel Premezclado"),
                            ("DESCARTABLES", "Descartables"),
                            ("ENVASES", "Envases"),
                            ("UTENSILIOS", "Utensilios"),
                            ("GAS_COCINA", "Gas Cocina"),
                            ("HIELO", "Hielo"),
                            ("DETERGENTES", "Detergentes"),
                            ("DESINFECTANTES", "Desinfectantes"),
                            ("UTENSILIOS_LIMPIEZA", "Utensilios Limpieza"),
                            ("PAPEL_SANITARIO", "Papel Sanitario"),
                            ("AMBIENTADORES", "Ambientadores"),
                            ("MEDICAMENTO", "Medicamento"),
                            ("CURACION", "Curación"),
                            ("EQUIPO_DIAGNOSTICO", "Equipo Diagnóstico"),
                            ...
                            ("GIMNASIO", "Gimnasio"),
                            ("COCINA_INDUSTRIAL", "Cocina Industrial"),
                            ...
                            ("CONSUMIBLE_IT", "Consumible IT"),
                            ("JUEGO_MESA", "Juego de Mesa"),
                            ("JUEGO_VIDEO", "Videojuego"),
                            ("LIBRO_REVISTA", "Libro / Revista"),
                            ("EVENTO", "Evento"),
                            ("SONIDO_LUZ", "Sonido / Luz"),
                            ("COSMETICO", "Cosmético"),
                            ("ACEITE_MASAJE", "Aceite de Masaje"),
                            ("SUPLEMENTO", "Suplemento"),
                            ("ACC_FITNESS", "Accesorio Fitness"),
                            ...
                            ("DETECTOR", "Detector"),
                            ("RECUERDO", "Recuerdo"),
                            ("PRENDA_LOGO", "Prenda con Logo"),
                            ("ACCESORIO_LOGO", "Accesorio con Logo"),
                            ("BEBIDA_PREMIUM", "Bebida Premium"),
                            ("DULCE_GOURMET", "Dulce Gourmet"),
                            ("ROUTER", "Router"),
                            ("SWITCH", "Switch"),
                            ("CABLEADO", "Cableado"),
                            ("CAMARA_SEGURIDAD", "Cámara de Seguridad"),
                            ("SENSOR", "Sensor"),
                            ("DISPOSITIVO_PORTATIL", "Dispositivo Portátil"),
                        ],
                        max_length=20,
                        null=True,
                    ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="compras.proveedores"
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="solicitudes_de_compra",
                        to="cruceros.crucero",
                    ),
                ),
            ],
