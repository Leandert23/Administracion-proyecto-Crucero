    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cantidad_productos', models.PositiveIntegerField()),
                ('estado', models.CharField(choices=[('PENDIENTE', 'Pendiente'), ('APROBADA', 'Aprobada'), ('POR_REGISTRAR', 'Por registrar'), ('DENEGADA', 'Denegada')], default='PENDIENTE', max_length=15)),
                ('fecha_creacion', models.DateField(default=apps.cruceros.Services.fecha_general.obtener_fecha_actual)),
                ('compra_lote', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ordenes_compra_en_almacen', to='compras.compralote')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unidad', models.CharField(choices=[('L', 'Litros'), ('M', 'Metros'), ('K', 'Kilogramos'), ('U', 'Unidades')], default='U', max_length=1)),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='solicitudes', to='almacen.producto')),
                ('solicitud', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='productos_solicitados', to='almacen.solicitudsalida')),
            ],
            options={
