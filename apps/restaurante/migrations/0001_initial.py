    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=100, verbose_name="Nombre del Crucero"),
                ),
                (
                    "description",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=100, verbose_name="Nombre del Plato"),
                ),
                (
                    "description",
                    models.TextField(blank=True, verbose_name="Descripción"),
                ...
                (
                    "included",
                    models.BooleanField(
                        default=True, verbose_name="Incluido en el Paquete"
                    ),
                ),
                (
                    "min_stock_alert",
                    models.IntegerField(
                        default=10, verbose_name="Alerta de Stock Mínimo"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_included",
                    models.BooleanField(verbose_name="Incluido en el Paquete"),
                ),
                (
                    "created_at",
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="Fecha de Consumo"
                    ),
                ),
                (
                    "menu_item",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=100, verbose_name="Nombre del Restaurante"
                    ),
                ),
                (
                    "type",
                ...
                (
                    "capacity",
                    models.IntegerField(default=100, verbose_name="Capacidad"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
                    "crucero",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reported_by",
                    models.CharField(max_length=100, verbose_name="Reportado por"),
                ),
                (
                    "created_at",
                    models.DateTimeField(
