"""
Django settings for crucero_admin project.
...
INSTALLED_APPS = [
    ...
    'mantenimiento',  # Nuestro módulo de mantenimiento
]
...
ROOT_URLCONF = 'crucero_admin.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'mantenimiento.context_processors.crucero_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'crucero_admin.wsgi.application'
